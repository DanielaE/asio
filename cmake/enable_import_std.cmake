...
if(ASIO_IMPORT_STD)
    ...
    if(CMAKE_CXX_STANDARD VERSION_LESS 23)
        message(WARNING "import std requires C++23 but have ${CMAKE_CXX_STANDARD}. Overriding CMAKE_CXX_STANDARD to 23...")
        set(CMAKE_CXX_STANDARD 23)
    endif()

    # 2. Clang libc++ Modules Path Setup
    # before project() we must detect clang by inspecting CMAKE_CXX_COMPILER
    if(NOT CMAKE_CXX_STDLIB_MODULES_JSON AND (CMAKE_CXX_COMPILER MATCHES "clang" OR CMAKE_CXX_COMPILER_ID STREQUAL "Clang"))
        execute_process(
        ...
        if(_clang_resource_dir)
            ...
            if(EXISTS "${_modules_json_path}")
                set(CMAKE_CXX_STDLIB_MODULES_JSON "${_modules_json_path}" CACHE PATH "Path to libc++.modules.json")
                message(STATUS "Found libc++.modules.json: ${CMAKE_CXX_STDLIB_MODULES_JSON}")
            endif()
        endif()
    endif()
